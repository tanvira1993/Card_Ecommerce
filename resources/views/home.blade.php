	...
	<section class="home-slidershow">
		<div class="slide-show">
			<div class="vt-slideshow">
				<ul>
					<li class="slide1" data-transition="random" ><img src="frontend/images/slider/home/bg_slider_1.jpg" alt="" />
				...
				<li class="slide2" data-transition="random" ><img src="frontend/images/slider/home/bg_slider_2.jpg" alt="" />
				...
				<li class="slide3" data-transition="random" ><img src="frontend/images/slider/home/bg_slider_3.jpg" alt="" />
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 block block-left">
				<a href="#" class="image">
					<img src="frontend/images/banner/category/1.jpg" alt="banner-category"/>
				</a>
				<div class="info">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 block block-center">
				<div class="inner-top">
					<div class="box-left">
						<a href="#" class="image frist">
							<img src="frontend/images/banner/category/2.jpg" alt="banner-category"/>
						</a>
						<div class="info">
							<a href="#">BROCHURE</a>
						</div>
					...
					<div class="box-right">
						<a href="#" class="image">
							<img src="frontend/images/banner/category/3.jpg" alt="banner-category"/>
						</a>
						<div class="info">
				...
				<div class="inner-bottom">
					<a href="#" class="image">
						<img src="frontend/images/banner/category/4.jpg" alt="banner-category"/>
					</a>
					<div class="info">
						<a href="#">LOGO PRINT</a>
					</div>
			...
			<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 block block-right">
				<div class="inner-top">
					<a href="#" class="image">
						<img src="frontend/images/banner/category/5.jpg" alt="banner-category"/>
					</a>
					<div class="info">
						<a href="#">ENVELOPE</a>
					</div>
				...
				<div class="inner-bottom">
					<a href="#" class="image">
						<img src="frontend/images/banner/category/6.jpg" alt="banner-category"/>
					</a>
					<div class="info">
			...
			<ul class="slider-w slider-owl">
				<li class="pro-item">
					<div class="product-image-action">
						<img src="frontend/images/product/263x263/1.jpg" alt="Grouper Business card">
						<div class="action">
				...
				<li class="pro-item">
					<div class="product-image-action">
						<img src="frontend/images/product/263x263/2.jpg" alt="New Brochures">
						<div class="action">
				...
				<li class="pro-item">
					<div class="product-image-action">
						<img src="frontend/images/product/263x263/3.jpg" alt="Flyers Two Page">
						<div class="action">
							<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
								<i class="fa fa-shopping-cart"></i>
							</button>
				...
				<li class="pro-item">
					<div class="product-image-action">
						<img src="frontend/images/product/263x263/4.jpg" alt="Business Card">
						<div class="action">
							<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
								<i class="fa fa-shopping-cart"></i>
							</button>
				...
				<li class="pro-item">
					<div class="product-image-action">
						<img src="frontend/images/product/263x263/eSliproser-postcard.jpg" alt="eSliproser Postcards">
						<div class="action">
							<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
								<i class="fa fa-shopping-cart"></i>
							</button>
				...
				<li class="pro-item">
					<div class="product-image-action">
						<img src="frontend/images/product/263x263/holiday-postcard-2.jpg" alt="Holiday Postcard 2">
						<div class="action">
							<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
								<i class="fa fa-shopping-cart"></i>
							</button>
				...
				<li class="pro-item">
					<div class="product-image-action">
						<img src="frontend/images/product/263x263/postcard-mailing-services.jpg" alt="Postcard Mailing Services">
						<div class="action">
							<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
								<i class="fa fa-shopping-cart"></i>
							</button>
				...
				<li class="pro-item">
					<div class="product-image-action">
						<img src="frontend/images/product/263x263/holiday-postcard.jpg" alt="Holiday Postcard">
						<div class="action">
							<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
								<i class="fa fa-shopping-cart"></i>
							</button>
				...
				<li class="pro-item">
					<div class="product-image-action">
						<img src="frontend/images/product/263x263/new-business-card.jpg" alt="New Business Card">
						<div class="action">
							<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
								<i class="fa fa-shopping-cart"></i>
							</button>
				...
				<li class="pro-item">
					<div class="product-image-action">
						<img src="frontend/images/product/263x263/holiday-postcard-3.jpg" alt="Holiday Postcard 3">
						<div class="action">
							<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
								<i class="fa fa-shopping-cart"></i>
							</button>
			...
			<div class="tab-content">
				<div class="tab-pane active" id="tab1">
					...
					<div class="col-md-6 col-sm-8 hidden-xs">
						<div class="pro-item large-item">
							<div class="product-image-action">
								<img src="frontend/images/product/business-card-large-item.jpg" alt="Grouper Business card">
								<div class="action">
									<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
										<i class="fa fa-shopping-cart"></i>
									</button>
					...
					<div class="col-md-3 col-sm-4">
						<div class="pro-item visible-xs">
							<div class="product-image-action">
								<img src="frontend/images/product/263x263/business-card-2.jpg" alt="Business card 2">
								<div class="action">
									<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
										<i class="fa fa-shopping-cart"></i>
									</button>
					...
					<div class="col-md-3 visible-md visible-lg">
						<div class="pro-item">
							<div class="product-image-action">
								<img src="frontend/images/product/263x263/new-postcard-card.jpg" alt="New Postcard Cards">
								<div class="action">
									<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
										<i class="fa fa-shopping-cart"></i>
									</button>
				...
				<div class="tab-pane" id="tab2">
					...
					<div class="col-md-3 visible-md visible-lg">
						<div class="pro-item">
							<div class="product-image-action">
								<img src="frontend/images/product/263x263/grouper-business-card.jpg" alt="New Postcard Cards">
								<div class="action">
									<button type="button" data-toggle="tooltip" data-placement="top" class="add-to-cart gbtn" title="Add to cart">
										<i class="fa fa-shopping-cart"></i>
									</button>
						...
						<div class="pro-item">
							<div class="product-image-action">
								<img src="frontend/images/product/263x263/flyers-two-page.jpg" alt="Postcard Mailing Services">
								<div class="action">
									<button type="button" data-toggle="tooltip" data-placement="top"  class="add-to-cart gbtn" title="Add to cart">
										<i class="fa fa-shopping-cart"></i>
									</button>
					...
					<div class="slider-inner">
						<div class="wrap-item">
							<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 item">
								<div class="inner">
									<a class="image" href="#">
										<img src="frontend/images/blog/1.jpg" alt="blog-01"/>
									</a>
									<div class="info">
										<div class="title">
		...
		<div class="row">
			...
			<div class="or-service-w">
				<div class="col-md-3 col-sm-6 col-xs-6 or-block">
					<div class="or-image">
						<a href="#">
							<img src="frontend/images/our_service/1.png" alt="service-01"/>
						</a>
					</div>
					<div class="or-title">
				...
				<div class="col-md-3 col-sm-6 col-xs-6 or-block">
					<div class="or-image">
						<a href="#">
							<img src="frontend/images/our_service/2.png" alt="service-02"/>
						</a>
					</div>
					<div class="or-title">
						<a href="#">Mailing</a>
				...
				<div class="col-md-3 col-sm-6 col-xs-6 or-block">
					<div class="or-image">
						<a href="#">
							<img src="frontend/images/our_service/3.png" alt="service-03"/>
						</a>
					</div>
					<div class="or-title">
				...
				<div class="col-md-3 col-sm-6 col-xs-6 or-block">
					<div class="or-image">
						<a href="#">
							<img src="frontend/images/our_service/4.png" alt="service-04"/>
						</a>
					</div>
					<div class="or-title">
				...
				<div class="tab-pane active" id="tab11">
					<div class="col-md-4 col-sm-6 col-xs-6 block-recent">
						<div class="w-block-recent">
							<div class="image-recent">
								<a href="#">
									<img src="frontend/images/our_service/5.png" alt="service-05"/>
								</a>
							</div>
					...
					<div class="col-md-4 col-sm-6 col-xs-6 block-recent">
						<div class="w-block-recent">
							<div class="image-recent">
								<a href="#">
									<img src="frontend/images/our_service/6.png" alt="service-06"/>
								</a>
							</div>
							<div class="info-recent">
								<h2 class="title">eSliproser Postcards</h2>
					...
					<div class="col-md-4 col-sm-6 col-xs-6 block-recent">
						<div class="w-block-recent">
							<div class="image-recent">
								<a href="#">
									<img src="frontend/images/our_service/7.png" alt="service-07"/>
								</a>
							</div>
							<div class="info-recent">
								<h2 class="title">eSliproser Postcards</h2>
					...
					<div class="col-md-4 col-sm-6 col-xs-6 block-recent">
						<div class="w-block-recent">
							<div class="image-recent">
								<a href="#">
									<img src="frontend/images/our_service/8.png" alt="service-08"/>
								</a>
							</div>
							<div class="info-recent">
								<h2 class="title">eSliproser Postcards</h2>
					...
					<div class="col-md-4 col-sm-6 col-xs-6 block-recent">
						<div class="w-block-recent">
							<div class="image-recent">
								<a href="#">
									<img src="frontend/images/our_service/9.png" alt="service-09"/>
								</a>
							</div>
							<div class="info-recent">
								<h2 class="title">eSliproser Postcards</h2>
					...
					<div class="col-md-4 col-sm-6 col-xs-6 block-recent">
						<div class="w-block-recent">
							<div class="image-recent">
								<a href="#">
									<img src="frontend/images/our_service/10.png" alt="service-10"/>
								</a>
							</div>
							<div class="info-recent">
								<h2 class="title">eSliproser Postcards</h2>
				...
				<div class="slider-inner">
					<div class="wrap-item">
						<div class="item">
							<div class="inner">
								<div class="image">
									<a href="#"><img src="frontend/images/testimonials/1.png" alt="terminal-01"/></a>
								</div>
								<div class="tes-name">
						...
						<div class="item">
							<div class="inner">
								<div class="image">
									<a href="#"><img src="frontend/images/testimonials/2.png" alt="terminal-01"/></a>
								</div>
								<div class="tes-name">
									<a href="#">Sam Ibister</a>
								</div>
						...
						<div class="item">
							<div class="inner">
								<div class="image">
									<a href="#"><img src="frontend/images/testimonials/3.png" alt="terminal-01"/></a>
								</div>
								<div class="tes-name">
									<a href="#">Sam Ibister</a>
								</div>
		...
		<div class="row">
			<div class="bran-block">
				<div class="item col-md-2 col-sm-4 col-xs-6">
					<a href="#" class="image">
						<img src="frontend/images/brands/1.png" alt="brand-01"/>
					</a>
				</div>
				<div class="item col-md-2 col-sm-4 col-xs-6">
					<a href="#" class="image">
						<img src="frontend/images/brands/2.png" alt="brand-02"/>
					</a>
				</div>
				<div class="item col-md-2 col-sm-4 col-xs-6">
					<a href="#" class="image">
						<img src="frontend/images/brands/3.png" alt="brand-03"/>
					</a>
				</div>
				<div class="item col-md-2 col-sm-4 col-xs-6">
					<a href="#" class="image">
						<img src="frontend/images/brands/4.png" alt="brand-04"/>
					</a>
				</div>
				<div class="item col-md-2 col-sm-4 col-xs-6">
					<a href="#" class="image">
						<img src="frontend/images/brands/5.png" alt="brand-05"/>
					</a>
				</div>
				<div class="item col-md-2 col-sm-4 col-xs-6">
					<a href="#" class="image">
						<img src="frontend/images/brands/6.png" alt="brand-06"/>
					</a>
				</div>
			</div>
		</div>
